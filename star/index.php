...
<div class="container">		
	...
	<div class="row">
		...
		<div><span class="average"><?php printf('%.1f', $average); ?> <small>/ 5</small></span> <span class="rating-reviews"><a href="show_rating.php?id=<?php echo $item["id"]; ?>">Rating & Reviews</a></span></div>
