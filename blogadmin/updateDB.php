<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('featured_homestay', "create table if not exists `featured_homestay` (   `id` INT unsigned not null auto_increment , primary key (`id`), `blog` INT unsigned not null ) CHARSET utf8", $silent);
		setupIndexes('featured_homestay', array('blog'));
